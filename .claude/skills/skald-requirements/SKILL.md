...
3. **Examples per rule — informally first.** Capture each example the
   ...
   [`references/gherkin-style.md`](references/gherkin-style.md) — hoist
   shared Given steps into a Background, one behaviour per scenario.)
